...
```  
![20241223_01](/images/2024-12-23-ROS2_class/20241223_01.png){: width="50%" height="50%"}{: .center}  
...
```  
![20241223_02](/images/2024-12-23-ROS2_class/20241223_02.png){: width="50%" height="50%"}{: .center}  

## Navigation 실행  
```
ros2 launch turtlebot3_navigation2 navigation2.launch.py use_sim_time:=True map:=$HOME/map.yaml
```  
![20241223_03](/images/2024-12-23-ROS2_class/20241223_03.png){: width="50%" height="50%"}{: .center}  

## 지도 저장  
```
ros2 run nav2_map_server map_saver_cli -f ~/map
```  
![20241223_04](/images/2024-12-23-ROS2_class/20241223_04.png){: width="50%" height="50%"}{: .center}  
